...
/**
 * Page class (sales_reports_summary)
 */
class sales_reports_summary extends sales_reports
{
	...
	// Page object name
	public $PageObjName = 'sales_reports_summary';
	public $Token = "";
	...
	public function __construct()
	{
		...
		// Table object (sales_reports)
		if (!isset($GLOBALS["sales_reports"])) {
			$GLOBALS["sales_reports"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["sales_reports"];
		}
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'sales reports');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fsales_reportssummary";
	...
	protected function setupExportOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fsales_reportssummary\" href=\"#\">" . $ReportLanguage->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fsales_reportssummary\" href=\"#\">" . $ReportLanguage->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $ReportLanguage->phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fsales_reportssummary\">" . $ReportLanguage->phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
	...
	public function loadRowValues($firstRow = FALSE)
	{
		...
		if (!$this->Recordset->EOF) {
			...
			$this->Values[4] = $this->Product_qty->CurrentValue;
			$this->Values[5] = $this->Sales_Order_Date->CurrentValue;
			$this->Values[6] = $this->Product_Price->CurrentValue;
			$this->Values[7] = $this->first_name->CurrentValue;
			$this->Values[8] = $this->last_name->CurrentValue;
			$this->Values[9] = $this->Company_Name->CurrentValue;
			$this->Values[10] = $this->taxable_amount->CurrentValue;
			$this->Values[11] = $this->tax_amount->CurrentValue;
			$this->Values[12] = $this->Total_Amount->CurrentValue;
		} else {
