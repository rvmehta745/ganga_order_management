...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'Wz3IUyqRYczwajSZ'); // Random key for encryption
...
$PROJECT_ID = "{07C8D5F2-E8DF-448E-9A2C-B3691CBD5CE8}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "riya", "qs" => "`", "qe" => "`");
